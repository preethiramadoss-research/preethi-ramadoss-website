...
export default function ResearchPage(){
  return (
    <div className="space-y-8">
      <header>
        <h1 className="text-2xl md:text-3xl font-semibold heading-accent">Research & Scientific Contributions</h1>
        <p className="mt-2 text-slate-600">Organized by research theme and selected publications.</p>
      </header>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-xl border bg-white p-6">
          ...
          <ul className="mt-5 space-y-4">
            {PUBLICATIONS.slice(0, 4).map((p, index) => (
              <li key={p.title} className="border-b border-slate-100 pb-4 last:border-0">
